...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.graphicsView.setGeometry(QtCore.QRect(250, 120, 541, 421))
        self.graphicsView.setObjectName("graphicsView")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(260, 10, 511, 101))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(_translate("MainWindow", "Register New Student"))
        self.pushButton_3.setText(_translate("MainWindow", "Browse Students"))
        self.pushButton_4.setText(_translate("MainWindow", "Add Report"))
        self.pushButton.setText(_translate("MainWindow", "Statistics"))
        self.label.setText(_translate("MainWindow", "Association of Early Intervention for Children with Disability"))
